...
SEED_SECRET_GITHUB_ID=$(echo -n "$SEED_SECRET_GITHUB_ID" | tr -d '\n')
SEED_SECRET_GITHUB_USERNAME=$(echo -n "$SEED_SECRET_GITHUB_USERNAME" | tr -d '\n')
SEED_SECRET_GITHUB_TOKEN=$(echo -n "$SEED_SECRET_GITHUB_TOKEN" | tr -d '\n')
